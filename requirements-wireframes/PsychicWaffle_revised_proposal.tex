...
\begin{itemize}
\item As a user, I want to log-in to the system with unique credentials so that my identity is verified before granting access to the trading platform
\item As a user, I want to enter a trade amount through a web interface so that I don't have to execute trades manually
\item As a user, I want my trades to be spaced out over some period of time so that I don't have to do that manually
\item As a user, I want to see the results of my transaction when it's over so that I can verify everything went well
\end{itemize}
